...
func TestLoadData(t *testing.T) {
	...
	list.AddIP4s([]string{"2.2.2.2"})
	data := []memxl.Data{
		{Resource: xlist.IPv4, Format: xlistd.Plain, Value: "11.22.33.44"},
		{Resource: xlist.IPv4, Format: xlistd.CIDR, Value: "10.5.0.0/16"},
		{Resource: xlist.IPv6, Format: xlistd.CIDR, Value: "2001:d00::/24"},
		{Resource: xlist.Domain, Format: xlistd.Sub, Value: "sucasa.com"},
		{Resource: xlist.IPv4, Format: xlistd.Plain, Value: "54.37.157.73"},
		{Resource: xlist.IPv4, Format: xlistd.Plain, Value: "192.168.10.10"},
		{Resource: xlist.Domain, Format: xlistd.Plain, Value: "www.micasa.com"},
		{Resource: xlist.IPv4, Format: xlistd.Plain, Value: "1.2.3.4"},
		{Resource: xlist.IPv6, Format: xlistd.Plain, Value: "fe80::3289:ad8e:8259:c878"},
	}
