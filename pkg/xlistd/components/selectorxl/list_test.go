...
func TestList_Check(t *testing.T) {
	//create services map
	services := make(map[xlist.Resource]xlistd.List)
...
func TestList_Ping(t *testing.T) {
	...
	var tests = []struct {
		checkers map[xlist.Resource]xlistd.List
		wantErr  bool
	}{
		{map[xlist.Resource]xlistd.List{}, false}, //0
		{map[xlist.Resource]xlistd.List{
			xlist.IPv4: rblOk,
		}, false}, //1
		{map[xlist.Resource]xlistd.List{
			xlist.IPv4:   rblOk,
...
func TestList_Resources(t *testing.T) {
	...
	var tests = []struct {
		...
		{map[xlist.Resource]xlistd.List{}, []xlist.Resource{}}, //0
		{map[xlist.Resource]xlistd.List{
			xlist.IPv4: rblOk,
		}, onlyIPv4}, //1
		{map[xlist.Resource]xlistd.List{
