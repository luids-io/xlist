...
var testwbefore1 = []listbuilder.ListDef{
	{ID: "list1",
		Class:     wbeforexl.BuildClass,
		Resources: onlyIPv4,
	...
	{ID: "list3",
		Class:     wbeforexl.BuildClass,
		Resources: onlyIP,
		Contains:  []listbuilder.ListDef{{ID: "mock1"}, {ID: "mock2"}, {ID: "mock2"}, {ID: "mock2"}}},
	{ID: "list4",
		Class:     wbeforexl.BuildClass,
		Resources: onlyIPv4,
...
func TestBuild(t *testing.T) {
	...
	for _, test := range tests {
		def, _ := listbuilder.FilterID(test.listid, testwbefore1)
